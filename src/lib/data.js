export const activities = [
  {
    ...
    tech: "Linux, Apache, Perl, Common Lisp, Python, PostgreSQL, SS7,  Dialogic STP, Netfors STP/SMSC, SMPP 3.4",
    list: [
  ...
  },
  {
    ...
    tech: "Chief Technology Officer, Project Manager, new hire training, Entrepreneur",
    list: [
